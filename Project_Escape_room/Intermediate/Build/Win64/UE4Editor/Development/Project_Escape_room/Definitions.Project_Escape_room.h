...
#define ORIGINAL_FILE_NAME "UE4Editor-Project_Escape_room.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Project_Escape_room
#define DEPRECATED_FORGAME DEPRECATED
#define PROJECT_ESCAPE_ROOM_API DLLEXPORT
